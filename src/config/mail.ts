...
if (!mailHost || !mailPort || !mailUser || !mailPass) {
  console.warn(
    "CONFIGURAÇÃO DE E-MAIL INCOMPLETA: Verifique as variáveis MAIL_HOST, MAIL_PORT, MAIL_USER, e MAIL_PASS no seu arquivo .env ou nas configurações do ambiente de produção."
  );
}
